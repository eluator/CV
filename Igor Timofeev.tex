...
\usepackage[margin=0.7in]{geometry}   % was 0.7in
\usepackage{enumitem}

\linespread{0.95}   % was 0.95
...
\begin{center}
    ...
    \textbf{Machine Learning Engineer with strong math and physics background and 6 years of experience in data science and bioinformatics research.}\\
\end{center}
...
\begin{itemize}
    \item \textbf{Machine Learning:} Classical ML, Deep Learning: VAE, GAN, Transformer, LLMs, RAG. Frameworks: PyTorch, TensorFlow, scikit-learn, openai, nltk, langchain, chromadb, ragas, transformers. MLOps: Wandb, Hydra, TensorBoard, DVC.
    \item \textbf{Programming:} Python, C/C++: opencv, boost.
    \item \textbf{Math Foundations:} Calculus, Linear Algebra, Differential Equations, Probability Theory, Statistics, Numerical Analysis, Algorithms \& Data Structures.
    \item \textbf{Physics:} Statistical Physics, Quantum Mechanics, Mechanics \& Celestial Mechanics.
...
\begin{itemize}
	...
	\item \href{https://www.tungstenautomation.com/}{\textbf{Tungsten Automation}} \hfill \textit{July 2025 - present}
	\begin{itemize}
    \item Conducted research in Python on Q\&A with RAG evaluation using two open-source datasets and synthetic data, leveraging the RAGAS library, LLM-as-a-judge, and claim decomposition.
    \item Researched methods for grounding text location evaluation in Python and deployed them in C++.
	\end{itemize}
...
\begin{itemize}
    ...
    \item 4th place in SignalNeuroHack hackathon with Huawei research project. \href{https://github.com/eluator/SignalNeuroHackTasks}{\faGithub} \href{https://drive.google.com/file/d/1BP5wC8w1eAIRWtIE0tXxjwbI0pZckC2r/view?usp=sharing}{\faChalkboardTeacher}
