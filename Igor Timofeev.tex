...
\begin{itemize}
	...
	\begin{itemize}
	\item Q\&A with RAG evaluation using two open sourced datasets and artificial data, RAGAS library, LLM-as-judge and claim decomposition.
	\item Evaluation of grounding text location.
	\end{itemize}
